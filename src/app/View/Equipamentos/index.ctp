                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Equipamentos<small></small></h2>
                              ...
                              <!--  <p>Add class <code>bulk_action</code> to table for bulk actions options on row select</p> -->
                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Defeito</th>
                                    ...
                                    <?php foreach ($equipamentos as $valor): ?>
                                            <tr class="even pointer">
                                                <td> <?php echo $this->Html->link($valor['Equipamento']['nome'],array('controller' => 'pedidos','action' => 'view',$valor['Equipamento']['id'])); ?> </td>
                                                <td> <?php echo $valor['Equipamento']['descricao_defeito']; ?> </td>
                                                <td> <?php echo $valor['Equipamento']['laboratorio_id']; ?> </td>
                                                <td> <?php echo $valor['Equipamento']['situacao']; ?> </td>
                                                <td> <?php echo $valor['Equipamento']['localizacao']; ?> </td>
                                                <td>
                                                  <?php
                                                    echo $this->Html->link('Editar sugestão', array('action' => 'edit', $valor['Pedido']['id']),array('class' => 'btn btn-round btn-default'));
                                                  ?>
                                                            <?php
                                                              echo $this->Html->link('Deletar', array('action' => 'delete', $valor['Pedido']['id']),array('class' => 'btn btn-round btn-danger'));
                                                            ?>
                                                </td>
                                            </tr>
                                              <?php endforeach ?>
