                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Alertas de Equipamentos<small></small></h2>
                              ...
                              <!--  <p>Add class <code>bulk_action</code> to table for bulk actions options on row select</p> -->
                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        <thead>
                                            <tr class="headings">
                                                <th class="column-title">Equipamento</th>
                                    ...
                                    <?php foreach ($equipamentos as $valor): ?>
                                            <tr class="even pointer">
                                                <td> <?php echo $this->Html->link($valor['Equipamento']['nome'],array('action' => 'view',$valor['Equipamento']['id'])); ?> </td>
                                                <td> <?php echo $valor['Laboratorio']['nome']; ?> </td>
                                                <td> <?php echo ($valor['Equipamento']['situacao'] == 0?'<span class="label label-danger">Danificado</span>':'<span class="label label-success">Consertado</span>'); ?></td>
                                                <td>
                                                  <?php
                                                    echo $this->Html->link('Editar', array('action' => 'edit', $valor['Equipamento']['id']),array('class' => 'btn btn-round btn-default'));
                                                    echo $this->Html->link('Consertar', array('action' => 'consert', $valor['Equipamento']['id']),array('class' => 'btn btn-round btn-success'));
                                                    echo $this->Html->link('Deletar', array('action' => 'delete', $valor['Equipamento']['id']),array('class' => 'btn btn-round btn-danger'));
                                                            ?>
                                                </td>
                                            </tr>
                                              <?php endforeach ?>
