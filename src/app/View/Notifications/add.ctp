            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                    ...
                                    <div class="col-md-12">
                                    <div class="input-group">
                                                    <!-- <input type="text" class="form-control" placeholder="buscar componentes"> -->
                                                    <?php echo $this->Form->input('Componente.campo',
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Itens Adicionados <small></small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                              ...
                              <table class="table table-hover">
                                    ...
                                    <?php
                                      if ($this->Session->check('lista')) {
                                        ...
                                        $indice = 0; ?>
                                      <tbody>
                                      <?php foreach ($componentes as $id => $componente): ?>
                                            <tr>
                                              <?php echo $this->Form->input('Notification.'.$indice.'.componente_id',array('type' => 'text'/*,'disabled' => 'disabled'*/,'label' => false,'value' => $id,'type' => 'hidden')); ?>
                                                ...
                                                <td><?php echo $this->Js->submit('Remover',array('url' => array('controller' => 'componentes','action' => 'rem_list',$id),'update' => '#car','class' => 'btn btn-warning btn-xs','div' => false)); ?></td>
                                            </tr>
                                            <?php 
                                              $indice++; 
                                              endforeach; 
        ...
        <footer>
          <div class="">
               <p class="pull-right">Sistema de gerenciamento online para componentes eletrônicos. |
                   <span class="lead">Componizer!</span>
               </p>
           </div>
           <div class="clearfix"></div>
       </footer>
