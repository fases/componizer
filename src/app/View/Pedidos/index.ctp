                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Lista de sugestões<small></small></h2>
                              ...
                              <!--  <p>Add class <code>bulk_action</code> to table for bulk actions options on row select</p> -->
                                    ...
                                    <?php foreach ($pedidos as $valor): ?>
                                            <tr class="even pointer">
                                                <td> <?php echo $this->Html->link($valor['Pedido']['nome'],array('controller' => 'pedidos','action' => 'view',$valor['Pedido']['id'])); ?> </td>
                                                <td> <?php echo $valor['Pedido']['descricao']; ?> </td>
                                                <td>
                                                  <?php
