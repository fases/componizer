                        ...
                        <div class="page-title">
                            ...
                            <div class="title_right">
                                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                    <?php $this->Form->create('Componente',array('action' => 'search'))?>
                              ...
                              <!--  <p>Add class <code>bulk_action</code> to table for bulk actions options on row select</p> -->
                                    ...
                                    <?php foreach ($componentes as $componente): ?>
                                                <tr class="even pointer">
                                                    <td> <?php echo $this->Html->link($componente['Componente']['nome'], array('action' => 'view', $componente['Componente']['id'])); ?> </td>
                                                    <td> <?php echo $componente ['Componente']['linha']; ?> </td>
                                                    <td> <?php echo $componente ['Componente']['coluna']; ?> </td>
                                                    <td> <div class="btn btn-round btn-default">
                                                    <?php
                                                      echo $this->Html->link('Editar', array('action' => 'edit', $componente['Componente']['id']));
                                                    ?></div>
                                                        <div class="btn btn-round btn-default">
                                                    <?php
                                                      echo $this->Html->link('Deletar', array('action' => 'delete', $componente['Componente']['id']));
                                                    ?></div></td>
                                                </tr>
                        <?php endforeach; ?>
