            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><?php echo $componentes['Componente']['nome'];?><small></small></h2>
                        ...
                        <tbody>
                                        				...
                                        				<tr class="even pointer">
																										<th> Quantidade: </th>
                                                    <td> <?php echo $componentes['Componente']['quantidade']; ?> </td>
																								</tr>
                                                    ...
                                                    <td> <?php echo $componentes['Componente']['linha']; ?> </td>
																								</tr>
																								<tr class="odd pointer">
																										<th> Posicionamento - coluna: </th>
                                                    <td> <?php echo $componentes['Componente']['coluna']; ?> </td>
																								</tr>
                                        <!---->
                                        </tbody>
