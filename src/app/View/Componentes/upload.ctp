            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Upload <small><?php echo $componente['Componente']['nome'];?></small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <?php echo $this->Session->flash(); ?>
                            <div class="x_content">

                              <?php echo $this->Form->create('Componente',array('type' => 'file', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Datasheet <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <div class="form-group">
                                          <?php echo $this->Form->file('datasheet',array('class' => 'form-control col-md-7 col-xs-12','label' => false,'multiple')); ?>
                                        </div>
                                      </div>
                                    </div>
