                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Cadastrar novo componente <small></small></h2>
                            ...
                            <?php echo $this->Session->flash(); ?>
                              ...
                              <?php echo $this->Form->create('Componente',array('action' => 'add', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                          ...
                                          ?>
                                          <?php echo $this->Html->link('Cancelar',array('controller' => 'componentes','action' => 'index'),array('class' => 'btn btn-danger')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
