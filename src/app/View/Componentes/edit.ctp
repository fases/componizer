                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Editar componente <small></small></h2>
                                    <div class="clearfix"></div>
                                </div>
                            <?php echo $this->Session->flash(); ?>
                                <div class="x_content">

                              <?php echo $this->Form->create('Componente',array('action' => 'edit', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricula">Quantidade <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('quantidade',array('class' => 'form-control col-md-7 col-xs-12','type' => 'number','placeholder'=> '','label' => false)); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Descrição</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->textarea('descricao',array('class' => 'form-control','rows' => '3','placeholder'=> '','label' => false)); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Categoria<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('categoria_id',array('type' => 'select','options' => $categorias,'label' => false, 'class' => 'form-control',));?>                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Subcategoria<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('subcategoria_id',array('type' => 'select','options' => $subcategorias,'label' => false, 'class' => 'form-control',));?>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricula">Linha <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('linha',array('class' => 'form-control col-md-7 col-xs-12','type' => 'number','placeholder'=> '','label' => false)); ?>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricula">Coluna <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('coluna',array('class' => 'form-control col-md-7 col-xs-12','type' => 'number','placeholder'=> '','label' => false)); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                          <?php
                                              ...
                                              echo $this->Html->link('Cancelar',array('controller' => 'componentes','action' => 'index'),array('class' => 'btn btn-danger'));
                                          ?>
                                        </div>
                                    </div>
                                    </form>
