            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Cadastrar novo laboratório <small></small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <?php echo $this->Form->create('Laboratorio',array('action' => 'add', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Sala <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('sala',array('class' => 'form-control col-md-7 col-xs-12','type' => 'number','placeholder'=> '','label' => false)); ?>
                                            <!--<input type="number" id="sala" name="sala" required="required" class="form-control col-md-7 col-xs-12" data-validate-length-range="3" data-validate-words="2" placeholder="">-->
                                        </div>
                                    </div>
