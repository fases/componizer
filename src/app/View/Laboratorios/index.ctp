                    ...
                    <div class="page-title">
                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                              <?php echo $this->Form->create('Laboratorio', array('action' => 'search'));?>
                        ...
                        <tbody>
                                    <?php foreach ($laboratorios as $valor): ?>
                                        <tr class="even pointer">
                                          <td> <?php echo $this->Html->link($valor['Laboratorio']['nome'], array('action' => 'view',
                                                                                    $valor['Laboratorio']['id'])); ?> </td>
                                          ...
                                          <td>
                                            ...
                                            echo $this->Html->link('Editar', array('action' => 'edit',
                                                                ...
                                                                echo $this->Html->link('Deletar',
                                                                        array('action' => 'delete',  $valor['Laboratorio']['id']),
