            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Lista de laboratórios <small></small></h2>
                        ...
                        <tbody>
                                    <?php foreach ($laboratorios as $valor): ?>
                                        <tr class="even pointer">
                                          ...
                                          <td>   <a>
                                            <?php
                                                $options = array('label' => 'Editar', 'class' => 'btn btn-round btn-default', 'div' => false, 'action' => 'edit', $valor['Laboratorio']['id']);
                                                echo $this->Form->end($options);
                                            ?></a></td>
                                          <td>  <a>
                                            <?php
                                                $options = array('label' => 'Deletar', 'class' => 'btn btn-round btn-default', 'div' => false, 'action' => 'delete', $valor['Laboratorio']['id']);
                                                echo $this->Form->end($options);
                                            ?></a></td>
                                          </tr>
                                          <?php endforeach ?>
