            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.ctp" class="site_title"><i class="fa fa-paw"></i> <span>Componizer!</span></a>
                    </div>
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Cadastrar nova categoria <small></small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <?php echo $this->Form->create('Categoria',array('action' => 'add', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('nome',array('class' => 'form-control col-md-7 col-xs-12','placeholder'=> '','label' => false)); ?>
                                            <!--<input type="text" id="nome" name="nome" required="required" class="form-control col-md-7 col-xs-12" data-validate-length-range="200" data-validate-words="2" placeholder="">-->
                                        </div>
                                    </div>
