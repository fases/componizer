                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Finalizar Requisição <small></small></h2>
                                    <div class="clearfix"></div>
                                <?php echo $this->Session->flash(); ?>
                                </div>
                                <div class="x_content">

                              <?php echo $this->Form->create('Emprestimo',array('action' => 'end', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                          ...
                                          foreach ($campos as $value): ?>
                                            <tr>
                                              <?php echo $this->Form->input('Componente.'.$indice.'.id',array('label' => false,'value' => $value['Componente']['id'],'type' => 'hidden')); ?>
                                                <td><?php echo $value['Componente']['nome']; ?></td>
                                                <td><?php echo $value['Notification']['quantidade']; ?></td>
                                                <td><?php echo $this->Form->input('Componente.'.$indice.'.quantidade',array('label' => false,'value' => 0,'class' => 'form-control')); ?></td>
                                            </tr>
                                            <?php $indice++;
                                            endforeach; ?>
                                        </tbody>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                          <?php
                                              $options = array('label' => 'Finalizar', 'class' => 'btn btn-success');
