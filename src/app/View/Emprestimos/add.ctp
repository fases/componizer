            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Criar nova requisição <small></small></h2>
                            ...
                            <div class="x_content">
                              ...
                              <?php echo $this->Form->create('Emprestimo',array('action' => 'add', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricula">Obeservações </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                          <?php
                                              $options = array('label' => 'Criar', 'class' => 'btn btn-success');
