                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo $emprestimos['Emprestimo']['id']?><small></small></h2>
                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="even pointer">
                                                <th> Data da Aula: </th>
                                                <td> <?php echo $emprestimos['Emprestimo']['data_aula']?> </td>
                                            </tr>
                                            <tr class="odd pointer">
                                                <th> Data do Empréstimo: </th>
                                                <td> <?php echo $emprestimos['Emprestimo']['data_emprestimo']?>º </td>
                                            </tr>
                                            <tr class="odd pointer">
                                                <th> Horário: </th>
                                                <td> <?php echo $emprestimos['Emprestimo']['horario']?>º </td>
                                            </tr>
                                            <tr class="odd pointer">
                                                <th> Solicitante: </th>
                                            ...
                                            <tr class="odd pointer">
                                                <th> Observações: </th>
                                                <td> <?php echo $emprestimos['Emprestimo']['observacoes']?> </td>
                                            </tr>
                                            <!---->
                                        </tbody>
                                    </table>
