                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Criar relatório de Estoque<small></small></h2>
                                    <div class="clearfix"></div>
                                <?php echo $this->Session->flash(); ?>
                                </div>
                                <div class="x_content">

                              <?php echo $this->Form->create('Emprestimo',array('action' => 'viewpdf', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('inicio', array('label' => false,'type' => 'date',
                                           'dateFormat' => 'DMY',
                                           'minYear' => date('Y') - 0,
                                           'maxYear' => date('Y') + 5 ));?>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Data de Término<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('fim', array('label' => false,'type' => 'date',
                                           'dateFormat' => 'DMY',
                                           'minYear' => date('Y') - 0,
                                           'maxYear' => date('Y') + 5 ));?>
                                        </div>
