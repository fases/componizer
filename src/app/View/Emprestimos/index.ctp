            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                  ...
                  <div class="navbar nav_title" style="border: 0;">
                        ...
                        array("alt" => "Logo", 'class' => 'img_logo_img img-round')),
                                  ...
                                  <tbody>
                                    <?php foreach ($emprestimos as $valor): ?>
                                      <tr class="even pointer">
                                        <td> <?php echo $this->Html->link($valor['Emprestimo']['nome'],array('action' => 'view',$valor['Emprestimo']['id'])); ?> </td>
                                        ...
                                        <td> <div class="btn btn-round btn-default">
                                                  <?php
                                                    echo $this->Html->link('Ver componentes', array('action' => 'listar', $valor['Emprestimo']['id']));
                                                  ?></div>
                                         <div class="btn btn-round btn-default">
                                                  <?php
                                                    echo $this->Html->link('Finalizar', array('action' => 'end', $valor['Emprestimo']['id']));
                                                  ?></div>
                                                   <div class="btn btn-round btn-default">
                                                            <?php
                                                              echo $this->Html->link('Editar', array('action' => 'edit', $valor['Emprestimo']['id']));
                                                            ?></div>
                                                   <div class="btn btn-round btn-default">
                                                            <?php
                                                              echo $this->Html->link('Deletar', array('action' => 'delete', $valor['Emprestimo']['id']));
                                                            ?></div></td>
                                    </tr>
                                              <?php endforeach ?>
