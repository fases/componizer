                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-circle"></i> Categorias <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="form.html">Listar categorias</a>
                                        </li>
                                        <li><a href="form_advanced.html">Cadastrar categoria</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-circle-o"></i> Subcategorias <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="general_elements.html">Listar subcategorias</a>
                                        </li>
                                        <li><a href="media_gallery.html">Cadastrar subcaegoria</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-cubes"></i> Componentes <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="tables_dynamic.html">Listar componentes</a>
                                        </li>
                                        <li><a href="tables_dynamic.html">Cadastrar componente</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-users"></i> Gerenciar usuários <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="chartjs.html">Listar usuários</a>
                                        </li>
                                        <li><a href="chartjs2.html">Cadastrar usuário</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-archive"></i> Requisições <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="chartjs.html">Listar requisições</a>
                                        </li>
                                        <li><a href="chartjs2.html">Criar requisições</a>
                                        </li>
