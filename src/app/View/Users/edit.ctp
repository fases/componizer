                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                              ...
                              <?php echo $this->Form->create('User',array('action' => 'edit', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <?php echo $this->Form->input('role', array(
                                            'options' => array('Aluno','Professor','Bolsista','Administrador'), 'class' => 'form-control','label' => false)); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                          <?php
                                              ...
                                              echo $this->Html->link('Cancelar',array('controller' => 'users','action' => 'index'),array('class' => 'btn btn-danger'));
                                          ?>
                                        </div>
                                    </div>
                                </form>
