            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><?php echo $usuarios['User']['nome'];?><small></small></h2>
                        ...
                        <tbody>
                                        				...
                                        				<tr class="even pointer">
																										<th> Matrícula: </th>
                                                    <td> <?php echo $usuarios['User']['matricula']; ?> </td>
																								</tr>
                                                    ...
                                                    <td> <?php echo $usuarios['User']['username']; ?> </td>
																							...
																							<!--	<tr class="even pointer">
																										<th> Senha: </th>
                                                    <td> <?php echo $usuarios['User']['password']; ?> </td>
																								</tr>-->
																								<tr class="odd pointer">
																										<th> E-mail: </th>
                                                    <td> <?php echo $usuarios['User']['email']; ?> </td>
																								</tr>
																								<tr class="even pointer">
																										<th> Telefone: </th>
                                                    <td> <?php echo $usuarios['User']['telefone']; ?> </td>
																								</tr>
																								<!--<tr class="odd pointer">
																										<th> Tipo de usuário: </th>
                                                    <td> <?php //echo $usuarios['User']['role']; ?> </td>
																								</tr>-->
                                 ...
                                 <div class="btn btn-round btn-default">
                                          <?php
                                            echo $this->Html->link('Editar', array('action' => 'edit_profile', $usuarios['User']['id']));
                                          ?></div>
                            </div>
                        </div>
                    </div>
