                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo $usuario['User']['nome'];?><small></small></h2>
                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="even pointer">
                                                <th> Matrícula: </th>
                                                <td> <?php echo $usuario['User']['matricula']; ?> </td>
                                            </tr>
                                            ...
                                            <tr class="even pointer">
                                                <th> Telefone: </th>
                                                <td> <?php echo $usuario['User']['telefone']; ?> </td>
                                            </tr>
                                            <tr class="odd pointer">
                                                <th> Tipo de usuário: </th>
                                                <td> <?php echo $usuario['User']['role'] == 0 ?'Aluno de Pesquisa/Extensão':($usuario['User']['role'] == 1? 'Aluno TAL/Bolsista':($usuario['User']['role'] == 2?'Professor':'Administrador')); ?> </td>
                                            </tr>
