                          ...
                          <ul class="nav side-menu">
                              <li><a><i class="fa fa-user"></i> Perfil <span class="fa fa-chevron-down"></span></a>
                                  <ul class="nav child_menu" style="display: none">
                                      <li><?php echo $this->Html->link(__('Meus dados'), array('controller' => '','action' => 'index')); ?>
                                      </li>
                                      <li><?php echo $this->Html->link(__('Alterar senha'), array('controller' => '','action' => 'index')); ?>
                                      </li>
                                  </ul>
                              </li>
                        ...
                        <tbody>
                          <?php foreach ($subcategories as $valor): ?>
                                        <tr class="even pointer">
                                          ...
                                          <td>   <a>
                                            <?php
                                                $options = array('label' => 'Editar', 'class' => 'btn btn-round btn-default', 'div' => false, 'action' => 'edit', $valor['Subcategoria']['id']);
                                                echo $this->Form->end($options);
                                            ?></a></td>
                                          <td>  <a>
                                            <?php
                                                $options = array('label' => 'Deletar', 'class' => 'btn btn-round btn-default', 'div' => false, 'action' => 'delete', $valor['Subcategoria']['id']);
                                                echo $this->Form->end($options);
                                            ?></a></td>
