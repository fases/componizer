                ...
                <div class="">
                  ...
                  <div class="title_right">
                      <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                        <?php echo $this->Form->create('Subcategoria', array('controller' => 'subcategorias', 'action' => 'search'));?>
                      ...
                      <tbody>
                        <?php foreach ($subcategorias as $subcategoria): ?>
                                      <tr class="even pointer">
                                        <td> <?php echo $this->Html->link($subcategoria['Subcategoria']['nome'],array('action' => 'view',$subcategoria['Subcategoria']['id'])); ?> </td>
                                        <td> <?php echo $subcategoria ['Subcategoria']['descricao']; ?> </td>
                                        <td> <?php echo $subcategoria ['Categoria']['nome']; ?> </td>
                                        <td>
                                                <?php
                                                       echo $this->Html->link('Novo Componente', 
                                                          array('controller' => 'componentes',
                                                        'action' => 'add', $subcategoria['Subcategoria']['id']),
