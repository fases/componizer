                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo $subcategories['Subcategoria']['nome'];?><small></small></h2>
                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="even pointer">
                                                <th> Descrição: </th>
                                                <td> <?php echo $subcategories['Subcategoria']['descricao']; ?> </td>
                                            </tr>
                                            <tr class="odd pointer">
                                                <th> Categoria: </th>
                                                <td> <?php echo $subcategories['Categoria']['nome']; ?> </td>
                                            </tr>
                                            <!---->
                                        </tbody>
