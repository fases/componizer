                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Editar subcategoria <small></small></h2>
                                <?php echo $this->Session->flash(); ?>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                <?php echo $this->Form->create('Subcategoria',array('action' => 'edit', 'class' => 'form-horizontal form-label-left', 'novalidate'));?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                          <?php
                                              ...
                                              echo $this->Html->link('Cancelar',array('controller' => 'subcategorias','action' => 'index'),array('class' => 'btn btn-danger'));
                                          ?>
                                        </div>
                                    </div>
                                    </form>
